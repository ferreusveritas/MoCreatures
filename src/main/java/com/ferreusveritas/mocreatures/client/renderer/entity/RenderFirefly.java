...
public class RenderFirefly extends RenderInsect<EntityFirefly> {

    public RenderFirefly(ModelBase modelbase) {
        super(modelbase);
        //this.addLayer(new LayerMoCFirefly(this));
    }

    @Override
    protected void preRenderCallback(EntityFirefly entityfirefly, float par2) {
    ...
    protected void rotateFirefly(EntityFirefly entityfirefly) {
    	GlStateManager.rotate(40F, -1F, 0.0F, 0.0F);
    }

    @Override
    protected ResourceLocation getEntityTexture(EntityFirefly entityfirefly) {
        return ((EntityFirefly) entityfirefly).getTexture();
    }
    /*
