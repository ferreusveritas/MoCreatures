...
import com.ferreusveritas.mocreatures.client.model.ModelEnt;
...
import com.ferreusveritas.mocreatures.client.model.ModelManticore;
...
public class MoCClientProxy extends MoCProxy {
    ...
    public void registerRenderInformation() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityEnt.class, new RenderMoC(new ModelEnt(), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityMole.class, new RenderMoC(new ModelMole(), 0F));
        RenderingRegistry.registerEntityRenderingHandler(EntityManticore.class, new RenderMoC(new ModelManticore(), 0.7F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityManticorePet.class, new RenderMoC(new ModelNewBigCat(), 0.5F));
    }
