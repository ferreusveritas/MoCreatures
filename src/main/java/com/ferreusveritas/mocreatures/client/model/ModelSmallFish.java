...
public class ModelSmallFish extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        EntitySmallFish smallFish = (EntitySmallFish)entity;
        ...
        GlStateManager.translate(xOffset, yOffset + 0.15f, zOffset);
