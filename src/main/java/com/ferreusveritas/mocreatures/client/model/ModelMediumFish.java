...
public class ModelMediumFish extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        EntityMediumFish mediumFish = (EntityMediumFish)entity;
        ...
        GlStateManager.translate(xOffset, yOffset + 0.25f, zOffset);
        this.Head.render(f5);
