...
public class EntityKomodo extends MoCEntityTameableAnimal {

    private int sitCounter;
    public int tailCounter;
    public int tongueCounter;
    public int mouthCounter;
    private static final DataParameter<Boolean> RIDEABLE = EntityDataManager.<Boolean>createKey(EntityKomodo.class, DataSerializers.BOOLEAN);
    ...
    public boolean isMyHealFood(ItemStack stack) {
        return !stack.isEmpty() && (stack.getItem() == Items.CHICKEN || stack.getItem() == Items.BEEF);
    }
