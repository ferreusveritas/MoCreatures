...
public class EntityDeer extends MoCEntityTameableAnimal {
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(1, new EntityAIFleeFromEntityMoC(this, new Predicate<Entity>() {
            public boolean apply(Entity entity) {
                return !(entity instanceof EntityDeer) && (entity.height > 0.8F || entity.width > 0.8F);
            }
    ...
    public boolean entitiesToInclude(Entity entity) {
        return !(entity instanceof EntityDeer) && super.entitiesToInclude(entity);
    }
