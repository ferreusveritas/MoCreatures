...
public class EntitySnail extends MoCEntityAmbient {

    private static final DataParameter<Boolean> IS_HIDDING = EntityDataManager.<Boolean>createKey(EntitySnail.class, DataSerializers.BOOLEAN);
