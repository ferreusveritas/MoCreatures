...
import com.ferreusveritas.mocreatures.entity.ai.EntityAIFollowHerd;
...
public class EntityPiranha extends EntitySmallFish {

	public static final String fishNames[] = {"Piranha"};

	public EntityPiranha(World world) {
		super(world);
		setTexture("smallfish_piranha");
	}
